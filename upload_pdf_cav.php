...
<? if ($response_array['status'] == 'success') { ?>
	window.opener.document.getElementById("archivoPDFtext_cav").value = "<?echo $file_name_new?>";
	window.opener.document.getElementById("descarga_pdf_cav").innerHTML = "<a href='http://nnoc.vtr.cl/gvaldivia/escalamiento_critico/documentos/<?echo $file_name_new?>' target='_blank'>Descargar</a>";
